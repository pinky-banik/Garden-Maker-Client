      ...
      .then((data) => {
        ...
        fetch(
          ...
          .then((result) => {
            ...
            setOrder(result);
            setOrderQuantity(
              parseInt(result?.orderQuantity) + minOrderQuantity
            );
        ...
        if (availableQuantity > orderQuantity) {
          setAvailableQuantity(
            availableQuantity - orderQuantity + minOrderQuantity
          );
        ...
        if (data) {
          ...
          swal({
            ...
            switch (option) {
              case "continue":
                toast.success(
                  "you are redirected to your Orders Dashboard to further process"
                );
        ...
        <div className="max-w-screen-xl mx-auto px-6 my-16 py-16 flex flex-col justify-center items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
            ...
            <div className="order-2 md:order-1 lg:order-1 flex flex-col justify-center text-center md:text-left">
              <h1 className="text-center md:text-left  text-3xl lg:text-4xl font-semibold poppins pb-4 text-gray-700 select-none">
                {name}
              </h1>
              ...
              <p>
                Next Order Quantity:{alreadyOrdered} +{minOrderQuantity}=
                {orderQuantity}
              </p>
              ...
              <div className="border-2 p-5">
                ...
                <p className="border-b-2">
                  Order Quantity : {newOrder?.orderQuantity}
                </p>
              ...
              <div className="flex items-center justify-center md:justify-start lg:justify-start space-x-6 pt-8">
                ...
                <div className="flex items-center border border-gray-200 px-4 py-2 space-x-6 rounded-full">
                  <AiOutlineMinus
                    onClick={() => handleMinusQuantity(quantity)}
                  ...
                  <AiOutlinePlus
                    onClick={() => handlePlusQuantity(quantity)}
                    className="text-2xl btn-primary w-8 h-8 rounded-full text-white hover:scale-105 transform transition duration-500 cursor-pointer p-1"
                  />
                </div>
              </div>
              ...
              <div className="mt-8 flex items-center justify-center md:justify-start lg:justify-start">
                <button
                  ...
                  className={
                    disabled
                      ? "flex items-center space-x-3 btn-primary btn px-6 py-3 text-accent ouline-primary poppins rounded-full outline-accent focus:ring-4 ring-accent transform transition duration-700 hover:scale-105"
                      : "flex items-center space-x-3 btn btn-primary px-6 py-3 text-white poppins rounded-full ring-secondary focus:outline-none focus:ring-4 transform transition duration-700 hover:scale-105"
                  }
